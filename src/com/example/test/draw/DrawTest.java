...
import com.example.test.draw.CanvasActivity;
import com.example.test.draw.MyView;
import com.example.test.draw.MyView.DrawMode;

public class DrawTest extends Activity implements Button.OnClickListener {
